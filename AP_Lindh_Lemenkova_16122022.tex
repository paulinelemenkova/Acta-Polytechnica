...
\begin{abstract}
In this paper, we present a new framework for improvement of \textcolor{blue}{soil strength} using advanced method of \textcolor{blue}{engineering statistics}. \textcolor{blue}{The materials included} clay till collected \textcolor{blue}{in} Yttre Ringvägen, \textcolor{blue}{southern} Sweden. \textcolor{blue}{Binders included} quicklime, \textcolor{blue}{slag} and ordinary Portland \textcolor{blue}{cement} used as pure binders and blended \textcolor{blue}{mixtures}. \textcolor{blue}{We first applied the} Response Surface Methodology \textcolor{blue}{techniques aimed at binder blend optimization}: 1) Central Composite Design\textcolor{blue}{;} 2) Box-Behnken Design\textcolor{blue}{;} 3) Simplex Lattice Design. \textcolor{blue}{The Pareto charts were presented for modelling responses from tests with changed binders \textcolor{blue}{and estimate their }effects on \textcolor{blue}{soil} strength. Finally, to examine variables important for soil stabilization, we also evaluated the }effects from the amount of binder \textcolor{blue}{and the} interaction between \textcolor{blue}{cement}/lime/\textcolor{blue}{slag} in changed ratio: 30-50-20\%; 50-50-0\%; 100-0-0\% \textcolor{blue}{The paper highlights the major opportunities and challenges of engineering statistics as a cross-cutting research direction for the issues of civil engineering.}
\end{abstract}
