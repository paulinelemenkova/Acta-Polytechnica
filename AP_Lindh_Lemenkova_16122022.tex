...
\begin{abstract}
In this paper, we present a new framework for improvement of engineering properties of soil using advanced method of stabilization with blended binders. The effects of binder ratios and water content on \textcolor{blue}{soil} strength were evaluated by statistical methods and Pareto charts. \textcolor{blue}{The materials included} clay till collected \textcolor{blue}{in} the Yttre Ringvägen, \textcolor{blue}{southern} Sweden. \textcolor{blue}{Binders included} quicklime, \textcolor{blue}{slag} and ordinary Portland \textcolor{blue}{cement} used as pure binders and blended \textcolor{blue}{mixtures}. \textcolor{blue}{We first applied the} Response Surface Methodology \textcolor{blue}{techniques aimed at binder blend optimization}: 1) Central Composite Design\textcolor{blue}{;} 2) Box-Behnken Design\textcolor{blue}{;} 3) Simplex Lattice Design. \textcolor{blue}{Next, the Pareto charts were presented for modelling responses from different tests with changed types and amount of binders.} The statistical analysis included quadratic model, regression analysis and ANOVA \textcolor{blue}{test} to analyse the efficiency \textcolor{blue}{of measurements}. \textcolor{blue}{Finally, to examine variables important for soil stabilization, we also evaluated the }effects from the amount of binder \textcolor{blue}{and the} interaction between \textcolor{blue}{cement}/lime/\textcolor{blue}{slag} in changed ratio: 30-50-20\%; 50-50-0\%; 100-0-0\% \textcolor{blue}{We demonstrated the applications of combinatorics for optimal combination of binders in soil stabilization. The paper highlights the major opportunities and challenges of engineering statistics as a cross-cutting research direction for the issues of civil engineering.}
\end{abstract}
...
The specific value of our research is that the methods and techniques have been borrowed from other industrial areas such as the automotive\hl{ sector} , chemical\hl{ engineering }and process \hl{industry}. Thus, we used the RSM as an advanced and efficient technique which can be used to optimise binder \hl{types} and amount \hl{for }soil stabilisation. Using this approach, we\hl{ }conducted \hl{the }extensive experiments on soil stabilisation using new \hl{binders }and novel methods of soil stabilisation which required different testing and evaluation methods\hl{ }to benchmark the performance of the framework. 
...
This paper is an important point in further development of these directions\hl{, presenting the combined }methods of statistical\hl{ }analysis, theoretical logic\hl{, }data science\hl{ and approaches of }combinatorics\hl{ for practical tasks of soil stabilization in civil }engineering\hl{.}
