...
Soil stabilisation is \hl{a }widely applied method of improving soil parameters and performance in civil engineering. It can be performed using various binders as stabilising agents \hl{used as single binders or in combinations}. Stabilization is a critically important task for improving soil properties in various areas of civil engineering \hl{such as} road constructions, bridge or building engineering, earthworks on pavements. The existing methods of soil stabilization aimed at improving soil performance to obtain the required characteristics \hl{of foundations. }Although the \hl{state-of-the art }methods \hl{are applicable, }new \hl{approaches using various }stabilisation agents and \hl{novel binders }require experimental testing and evaluation to assess their quality and effectiveness. 
