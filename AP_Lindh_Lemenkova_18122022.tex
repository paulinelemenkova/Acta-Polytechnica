...
Note that \hl{the }hypothesis \hl{is }made concerning the impact of factors\hl{, i.e., binders, }to analyse the effects from combination\hl{ }of\hl{ }values from \hl{these }factors \cite{StatSoft}. Using this general model\hl{, }we \hl{have }benefits in several aspects as follows:
